...
ModelType = Literal["cphm", "cmm", "tdcm", "thmm", "aft_ln", "aft_weibull", "aft_log_logistic", "competing_risks", "competing_risks_weibull"]
...
def generate(model: str, **kwargs: Any) -> pd.DataFrame:
    ...
    Args:
        model: Name of the generator to run. Must be one of ``cphm``, ``cmm``,
            ...
            ``competing_risks``, or ``competing_risks_weibull``.
        **kwargs: Arguments forwarded to the chosen generator. These vary by model:
            - cphm: n, model_cens, cens_par, beta, covar
            - cmm: n, model_cens, cens_par, beta, covar, rate
            - tdcm: n, dist, corr, dist_par, model_cens, cens_par, beta, lam
            - thmm: n, model_cens, cens_par, beta, covar, rate
